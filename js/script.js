    ...
    var Pi = u(() => {
        window.tram = (function (e) {
            ...
            var p = (function (l, v, y) {
                    ...
                    function z(re, he) {
                        ...
                        return (
                            ...
                            (W.open = function (Pe) {
                                if (((le = {}), _(Pe) ? (le = Pe.call(W, rt, Se, W, re)) : T(Pe) && (le = Pe), T(le))) for (var Tr in le) v.call(le, Tr) && (rt[Tr] = le[Tr]);
            ...
            var L = (t.frame = (function () {
                ...
                k = p(function (l) {
                    ...
                    function y(Z, fe, Ie) {
                        if (Z) {
                            var pe = typeof Z;
                            if ((fe || (this.timer && this.timer.destroy(), (this.queue = []), (this.active = !1)), pe == "number" && fe)) return (this.timer = new Ee({ duration: Z, context: this, complete: O })), void (this.active = !0);
                            if (pe == "string" && fe) {
                                switch (Z) {
                                    case "hide":
                                        W.call(this);
                            ...
                            if (pe == "object") {
                                ...
                                rt.call(
                                    ...
                                    Se.call(this),
                                    De > 0 && ((this.timer = new Ee({ duration: De, context: this })), (this.active = !0), fe && (this.timer.complete = O));
                                var je = this,
                                    Xe = !1,
                                    an = {};
                                L(function () {
                    ...
                    function T(Z) {
                        (Z = c(Z, 0)), this.active ? this.queue.push({ options: Z }) : ((this.timer = new Ee({ duration: Z, context: this, complete: O })), (this.active = !0));
                    }
                    function _(Z) {
                ...
                ce = p(F, function (l, v) {
                    ...
                    (l.init = function () {
                        ...
                        (l.transition = function (T) {
                            var _ = this.values(T);
                            this.tween = new pt({ current: this.current, values: _, duration: this.duration, delay: this.delay, ease: this.ease });
                            var O,
                                z = {};
                        ...
                        (l.fallback = function (T) {
                            var _ = this.values(T);
                            this.tween = new pt({ current: this.current, values: _, duration: this.duration, delay: this.delay, ease: this.ease, update: this.update, context: this });
                        }),
                        (l.update = function () {
                            d(this.el, this.name, this.style(this.current));
                        }),
            ...
            var d = e.style,
                ...
                _e = {};
            X.transform && ((B.transform = [ce]), (_e = { x: [q, "translateX"], y: [q, "translateY"], rotate: [G], rotateX: [G], rotateY: [G], scale: [I], scaleX: [I], scaleY: [I], skew: [G], skewX: [G], skewY: [G] })),
        ...
        _s.exports = (function () {
            ...
            var t = {},
                ...
                q = (e.each = e.forEach = function (m, P, M) {
                    ...
                    } else for (var te = e.keys(m), X = 0, $ = te.length; X < $; X++) if (P.call(M, m[te[X]], te[X], m) === t) return;
                    return m;
                });
...
` +
        ...
        Rs.define(
            ...
            (Cs.exports = function (e) {
                ...
                t.ready = function () {
                    ...
                    /\.webflow\.io$/i.test(b) && a.hostname !== b && (g = !0), g && !s && ((f = f || p()), h(), setTimeout(h, 500), e(r).off(c, E).on(c, E));
                };
                function E() {
    ...
    var Xo = u((Lr) => {
        ...
        function Jl(e, t, r) {
            ...
            function h(S) {
                if (!(0, wS.default)(S)) throw new Error("Actions must be plain objects. Use custom middleware for async actions.");
            ...
            function b() {
                ...
                return (
                    ...
                    (S[$l.default] = function () {
                        return this;
                    }),
                    S
                );
            }
            return h({ type: Ql.INIT }), (n = { dispatch: h, subscribe: p, getState: E, replaceReducer: g }), (n[$l.default] = b), n;
        }
    });
    var Vo = u((Uo) => {
        "use strict";
    ...
    var rf = u((Wo) => {
        ...
        function PS(e) {
            ...
            return function () {
                ...
                if (s) throw s;
                if (!1) var p;
                for (var h = !1, g = {}, b = 0; b < o.length; b++) {
                    var S = o[b],
                        x = r[S],
                        A = f[S],
                        w = x(A, E);
    ...
    var cf = u((bn) => {
        ...
        var cb = zo(),
            { TRANSFORM_MOVE: lb, TRANSFORM_SCALE: fb, TRANSFORM_ROTATE: db, TRANSFORM_SKEW: pb, STYLE_SIZE: vb, STYLE_FILTER: Eb, STYLE_FONT_VARIATION: hb } = cb.ActionTypeConsts,
    ...
    var xf = u((Ln) => {
        ...
        var YA = zA(Pr()),
            $A = Ue(),
            QA = tr(),
            { IX2_PREVIEW_REQUESTED: ZA, IX2_PLAYBACK_REQUESTED: JA, IX2_STOP_REQUESTED: e0, IX2_CLEAR_REQUESTED: t0 } = $A.IX2EngineActionTypes,
            r0 = { preview: {}, playback: {}, stop: {}, clear: {} },
            qf = Object.create(null, { [ZA]: { value: "preview" }, [JA]: { value: "playback" }, [e0]: { value: "stop" }, [t0]: { value: "clear" } }),
            n0 = (e = r0, t) => {
                if (t.type in qf) {
                    let r = [qf[t.type]];
    ...
    var oa = u((ZH, ip) => {
        ...
        function NR(e, t, r, n, i, o) {
            ...
            for (o.set(e, t), o.set(t, e); ++p < s; ) {
                var b = e[p],
                    S = t[p];
                if (n) var x = a ? n(S, b, p, t, e, o) : n(b, S, p, e, t, o);
                if (x !== void 0) {
                    if (x) continue;
                    h = !1;
                    break;
                ...
                if (g) {
                    if (
                        !AR(t, function (A, w) {
                            if (!wR(g, w) && (b === A || i(b, A, r, n, o))) return g.push(w);
                        })
                    ) {
                        h = !1;
                        break;
    ...
    var jn = u((N5, _v) => {
        var pa = av(),
            ...
            uq = ur(ga),
            Ft = gv;
        ((pa && Ft(new pa(new ArrayBuffer(1))) != hv) || (va && Ft(new va()) != dv) || (Ea && Ft(Ea.resolve()) != pv) || (ha && Ft(new ha()) != vv) || (ga && Ft(new ga()) != Ev)) &&
            (Ft = function (e) {
                var t = gv(e),
        ...
        function Eq(e, t, r, n, i, o) {
            ...
            if (!(r & pq)) {
                var g = E && Sv.call(e, "__wrapped__"),
                    b = p && Sv.call(t, "__wrapped__");
                if (g || b) {
                    var S = g ? e.value() : e,
                        x = b ? t.value() : t;
                    return o || (o = new _a()), i(S, x, r, n, o);
                }
            }
        ...
        HE.exports = function (t, r, n, i) {
            ...
            function s(c) {
                ...
                var h = (c - o[E]) / (o[E + 1] - o[E]),
                    g = f + h * ti,
                    b = BE(g, t, n);
                return b >= LL ? GL(c, g, t, n) : b === 0 ? g : FL(c, f, f + ti, t, n);
            }
            return function (f) {
    ...
    var Uh = u((ge) => {
        ...
        function Wa({ config: e, event: t, eventTarget: r, elementRoot: n, elementApi: i }) {
            ...
            let { targets: c } = e;
            if (Array.isArray(c) && c.length > 0) return c.reduce((M, X) => M.concat(Wa({ config: { target: X }, event: t, eventTarget: r, elementRoot: n, elementApi: i })), []);
            let { getValidDocument: f, getQuerySelector: E, queryDocument: p, getChildElements: h, getSiblingElements: g, matchSelector: b, elementContains: S, isSiblingNode: x } = i,
                { target: A } = e;
            if (!A) return [];
            ...
            let Y = ((o = t == null || (a = t.action) === null || a === void 0 || (s = a.config) === null || s === void 0 ? void 0 : s.affectedElements) !== null && o !== void 0 ? o : {})[w || N] || {},
                ...
                m,
                P = t && E(bh(t.target));
            if ((ie ? ((ee = Y.limitAffectedElements), (D = P), (m = E(Y))) : (D = m = E({ id: w, selector: N, selectorGuids: C })), t && G)) {
                let M = r && (m || G === !0) ? [r] : p(P);
                if (m) {
                    if (G === JD) return p(m).filter((X) => M.some(($) => S(X, $)));
                    if (G === Ih) return p(m).filter((X) => M.some(($) => S($, X)));
                    if (G === Th) return p(m).filter((X) => M.some(($) => x($, X)));
                }
                return M;
            }
            return D == null || m == null ? [] : Fe.IS_BROWSER_ENV && n ? p(m).filter((M) => n.contains(M)) : ee === Ih ? p(D, m) : ee === ZD ? h(p(D)).filter(b(m)) : ee === Th ? g(p(D)).filter(b(m)) : p(m);
        }
            ...
            switch (n.actionTypeId) {
                ...
                case Er: {
                    let s = o(e, ct),
                        ...
                        E;
                    return (
                        n.config.widthUnit === wt ? (f = Ah.test(s) ? parseFloat(s) : parseFloat(r.width)) : (f = (0, At.default)(parseFloat(s), parseFloat(r.width))),
        ...
        var Ba = {
            ...
            yM = Object.freeze({ blur: 0, "hue-rotate": 0, invert: 0, grayscale: 0, saturate: 100, sepia: 0, contrast: 100, brightness: 100 }),
        ...
        function OM(e, t, r, n, i) {
            let o = TM.map((s) => {
                    let c = Ba[s],
                        { xValue: f = c.xValue, yValue: E = c.yValue, zValue: p = c.zValue, xUnit: h = "", yUnit: g = "", zUnit: b = "" } = t[s] || {};
                    switch (s) {
                        case dr:
                            return `${WD}(${f}${h}, ${E}${g}, ${p}${b})`;
                        case pr:
                            return `${BD}(${f}${h}, ${E}${g}, ${p}${b})`;
                        case vr:
                            return `${HD}(${f}${h}) ${kD}(${E}${g}) ${jD}(${p}${b})`;
                        case Qr:
                            return `${KD}(${f}${h}, ${E}${g})`;
                        default:
                            return "";
        ...
        function qM({ element: e, actionTypeId: t, computedStyle: r, getStyle: n }) {
            let i = Va[t],
                ...
                a = RM.test(o) ? o : r[i],
                s = NM(CM, a).split($r);
            return { rValue: (0, At.default)(parseInt(s[0], 10), 255), gValue: (0, At.default)(parseInt(s[1], 10), 255), bValue: (0, At.default)(parseInt(s[2], 10), 255), aValue: (0, At.default)(parseFloat(s[3]), 1) };
        }
        ...
        function Rh({ actionGroup: e, event: t, elementApi: r }) {
            ...
            n.forEach(({ actionTypeId: i, config: o }) => {
                let a;
                (0, ft.isPluginType)(i) ? (a = (0, ft.clearPlugin)(i)) : (a = Gh({ effect: MM, actionTypeId: i, elementApi: r })), Wa({ config: o, event: t, elementApi: r }).forEach(a);
            });
        }
        function DM(e, t, r) {
        ...
        var Gh = ({ effect: e, actionTypeId: t, elementApi: r }) => (n) => {
            switch (t) {
                case dr:
                case pr:
                case vr:
    ...
    var Hh = u((fi) => {
        ...
        var Vh = Ue(),
            Wh = Wt(),
            mr = tr(),
            { IX2_RAW_DATA_IMPORTED: $M, IX2_SESSION_STOPPED: QM, IX2_INSTANCE_ADDED: ZM, IX2_INSTANCE_STARTED: JM, IX2_INSTANCE_REMOVED: eF, IX2_ANIMATION_FRAME_CHANGED: tF } = Vh.IX2EngineActionTypes,
            ...
            aF = (e, t) => {
                let { position: r, parameterId: n, actionGroups: i, destinationKeys: o, smoothing: a, restingValue: s, actionTypeId: c, customEasingFn: f, skipMotion: E, skipToValue: p } = e,
            ...
            sF = (e, t) => {
                let { active: r, origin: n, start: i, immediate: o, renderType: a, verbose: s, actionItem: c, destination: f, destinationKeys: E, pluginDuration: p, instanceDelay: h, customEasingFn: g, skipMotion: b } = e,
                    S = c.config.easing,
                    { duration: x, delay: A } = c.config;
                p != null && (x = p), (A = h ?? A), a === nF ? (x = 0) : (o || b) && (x = A = 0);
                let { now: w } = t.payload;
                if (r && n) {
                    let I = w - (i + A);
                    if (s) {
    ...
    var jh = u((pi) => {
        ...
        var vF = Ko(),
            ...
            TF = (0, vF.combineReducers)({ ixData: EF.ixData, ixRequest: hF.ixRequest, ixSession: gF.ixSession, ixElements: IF, ixInstances: yF.ixInstances, ixParameters: mF.ixParameters });
        pi.default = TF;
    });
    var Kh = u((Uk, en) => {
        function OF(e, t) {
    ...
    var t_ = u((pj, e_) => {
        ...
        function U2(e, t, r) {
            ...
            return G2(r) && ((n = "leading" in r ? !!r.leading : n), (i = "trailing" in r ? !!r.trailing : i)), F2(e, t, { leading: n, maxWait: t, trailing: i });
        }
        e_.exports = U2;
    });
    var vi = u((ae) => {
        ...
        var fG = ({ hasBoundaryNodes: e, reducedMotion: t }) => ({ type: H2, payload: { hasBoundaryNodes: e, reducedMotion: t } });
        ...
        var EG = ({ actionTypeId: e = n_.ActionTypeConsts.GENERAL_START_ACTION, actionListId: t, actionItemId: r, eventId: n, allowEvents: i, immediate: o, testManual: a, verbose: s, rawData: c }) => ({
            type: z2,
            payload: { actionTypeId: e, actionListId: t, actionItemId: r, testManual: a, eventId: n, allowEvents: i, immediate: o, verbose: s, rawData: c },
        });
        ...
        var He = Si(Pr()),
            ...
            We = ({ store: e, event: t, element: r, eventStateKey: n }, i) => {
                let { action: o, id: a } = t,
                    ...
                    f = wy(e, c);
                return (
                    f && (0, rs.stopActionGroup)({ store: e, eventId: c, eventTarget: r, eventStateKey: c + py + n.split(py)[1], actionListId: (0, dU.default)(f, "action.config.actionListId") }),
            ...
            gy = (e) => (t, r = {}) => {
                ...
                let g = (E ? c : (o * (c || 0)) / 100) / p,
                    ...
                    S,
                    x = 0;
                r && ((b = h > r.percentTop), (S = r.scrollingDown !== b), (x = S ? h : r.anchorTop));
                let A = s === Iy ? h >= x + g : h <= x - g,
                    w = (0, He.default)({}, r, { percentTop: h, inBounds: A, anchorTop: x, scrollingDown: b });
            ...
            yy = (0, He.default)({}, os, {
                handler: WU((e, t) => {
                    let { elementVisible: r } = t,
                        ...
                        { ixData: o } = i.getState(),
                        { events: a } = o;
                    return !a[n.action.config.autoStopEventId] && t.triggered ? t : (n.eventTypeId === Ty) === r ? (We(e), (0, He.default)({}, t, { triggered: !0 })) : t;
                }),
            }),
            my = 0.05,
            jU = {
                ...
                [CU]: {
                    ...
                    handler: ({ store: e, element: t, eventConfig: r, nativeEvent: n, eventStateKey: i }, o = { clientX: 0, clientY: 0, pageX: 0, pageY: 0 }) => {
                        let { basedOn: a, selectedAxis: s, continuousParameterGroupId: c, reverse: f, restingState: E = 0 } = r,
                            { clientX: p = o.clientX, clientY: h = o.clientY, pageX: g = o.pageX, pageY: b = o.pageY } = n,
                            S = s === "X_AXIS",
                            x = n.type === "mouseout",
                            A = E / 100,
                            w = c,
                        ...
                        switch (a) {
                            case Bt.EventBasedOn.VIEWPORT: {
                                A = S ? Math.min(p, window.innerWidth) / window.innerWidth : Math.min(h, window.innerHeight) / window.innerHeight;
                                break;
                            }
                        ...
                        return (
                            ...
                            (a !== Bt.EventBasedOn.ELEMENT || I || I !== o.elementHovered) && ((A = f ? 1 - A : A), e.dispatch((0, Ii.parameterChanged)(w, A))),
                            { elementHovered: I, clientX: p, clientY: h, pageX: g, pageY: b }
                        );
                    },
                },
                [DU]: {
                ...
                [xU]: {
                    ...
                    handler: ({ element: e, store: t, eventConfig: r, eventStateKey: n }, i = { scrollPercent: 0 }) => {
                        let { scrollLeft: o, scrollTop: a, scrollWidth: s, scrollHeight: c, clientHeight: f } = tn(),
                            { basedOn: E, selectedAxis: p, continuousParameterGroupId: h, startsEntering: g, startsExiting: b, addEndOffset: S, addStartOffset: x, addOffsetValue: A = 0, endOffsetValue: w = 0 } = r,
                            I = p === "X_AXIS";
    ...
    var as = u((Ct) => {
        ...
        var zU = tt(Pr()),
            ...
            ss = (e) => iV.includes(e),
            { COLON_DELIMITER: us, BOUNDARY_SELECTOR: Ai, HTML_ELEMENT: Py, RENDER_GENERAL: oV, W_MOD_IX: qy } = et.IX2EngineConstants,
            {
        ...
        function AV(e, t) {
            ...
            if ((Ci({ store: t, rawData: E, allowEvents: a, testManual: c }), (n && r === et.ActionTypeConsts.GENERAL_START_ACTION) || ss(r))) {
        ...
        function Ci({ store: e, rawData: t, allowEvents: r, testManual: n }) {
            ...
            t && e.dispatch((0, Oe.rawDataImported)(t)),
                i.active ||
                    (e.dispatch((0, Oe.sessionInitialized)({ hasBoundaryNodes: !!document.querySelector(Ai), reducedMotion: document.body.hasAttribute("data-wf-ix-vacation") && window.matchMedia("(prefers-reduced-motion)").matches })),
        ...
        function xV({ store: e, eventStateKey: t, eventTarget: r, eventId: n, eventConfig: i, actionListId: o, parameterGroup: a, smoothing: s, restingValue: c }) {
            ...
            A.forEach((N) => {
                ...
                x.forEach(({ element: N, key: C }) => {
                    ...
                    vs({ store: e, element: N, eventId: n, actionListId: o, actionItem: G, destination: ie, continuous: !0, parameterId: w, actionGroups: q, smoothing: s, restingValue: c, pluginInstance: Y });
                });
        }
        function LV(e = [], t, r) {
            let n = [...e],
        ...
        function UV({ logic: e, store: t, events: r }) {
            ...
            (0, on.default)(s, (p, h) => {
                ...
                gV(x, o.mediaQueryKeys) || t.dispatch((0, Oe.mediaQueriesDefined)()),
                    b.actionTypeId === et.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION &&
                        (Array.isArray(g.config) ? g.config : [g.config]).forEach((I) => {
                            ...
                            q &&
                                p.forEach((Y, ie) => {
                                    let ee = S + us + ie;
                                    xV({ store: t, eventStateKey: ee, eventTarget: Y, eventId: S, eventConfig: I, actionListId: A, parameterGroup: q, smoothing: G, restingValue: j });
                                });
                        }),
                    (b.actionTypeId === et.ActionTypeConsts.GENERAL_START_ACTION || ss(b.actionTypeId)) && Gy({ store: t, actionListId: A, eventId: S });
            });
            let c = (p) => {
                    ...
                    GV(s, (g, b, S) => {
                        ...
                        let N = (C = {}) => {
                            let q = i({ store: t, element: g, event: x, eventConfig: C, nativeEvent: p, eventStateKey: S }, A);
                            _V(q, A) || t.dispatch((0, Oe.eventStateChanged)(S, q));
                        };
                ...
                E = ({ target: p = document, types: h, throttle: g }) => {
                    h.split(" ")
                        ...
                        .forEach((b) => {
                            let S = g ? f : c;
                            p.addEventListener(b, S), t.dispatch((0, Oe.eventListenerAdded)(p, [b, S]));
                        });
                };
            ...
            if (c && c.useFirstGroupAsInitialState) {
                ...
                f.forEach((p) => {
                    ...
                    let { config: g, actionTypeId: b } = p,
                        S = (g == null || (h = g.target) === null || h === void 0 ? void 0 : h.useEventTarget) === !0 ? { target: s.target, targets: s.targets } : g,
                        x = wi({ config: S, event: s, elementApi: we }),
                        A = ls(b);
                    x.forEach((w) => {
                        let I = A ? fs(b)(w, p) : null;
                        vs({ destination: cs({ element: w, actionItem: p, elementApi: we }, I), immediate: !0, store: e, element: w, eventId: r, actionItem: p, actionListId: t, pluginInstance: I });
                    });
                });
            }
        }
        ...
        function ps({ store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: i, groupIndex: o = 0, immediate: a, verbose: s }) {
            var c;
            let { ixData: f, ixSession: E } = e.getState(),
                { events: p } = f,
                h = p[t] || {},
                { mediaQueries: g = f.mediaQueryKeys } = h,
                b = (0, Rt.default)(f, `actionLists.${i}`, {}),
                { actionItemGroups: S, useFirstGroupAsInitialState: x } = b;
            if (!S || !S.length) return !1;
            o >= S.length && (0, Rt.default)(h, "config.loop") && (o = 0), o === 0 && x && o++;
            let w = (o === 0 || (o === 1 && x)) && ss((c = h.action) === null || c === void 0 ? void 0 : c.actionTypeId) ? h.config.delay : void 0,
                I = (0, Rt.default)(S, [o, "actionItems"], []);
        ...
        function vs(e) {
            ...
            let { store: r, computedStyle: n } = e,
                ...
                { refState: w } = b[A] || {},
                I = we.getRefType(o),
                N = S.reducedMotion && et.ReducedMotionTypes[a.actionTypeId],
                C;
            if (N && f)
            ...
            if ((r.dispatch((0, Oe.instanceAdded)((0, zU.default)({ instanceId: g, elementId: A, origin: q, refType: I, skipMotion: N, skipToValue: C }, i))), Uy(document.body, "ix2-animation-started", g), s)) {
                WV(r, g);
                return;
            }
            Ht({ store: r, select: ({ ixInstances: G }) => G[g], onChange: Vy }), h && r.dispatch((0, Oe.instanceStarted)(g, S.tick));
        }
        function Es(e, t) {
        ...
        function Vy(e, t) {
            ...
            if (Ri(G, N.mediaQueryKey) && (n || r || i)) {
                ...
                if (i) {
                    if (S) {
                        let j = ps({ store: t, eventId: p, eventTarget: h, eventStateKey: g, actionListId: b, groupIndex: E + 1, verbose: A });
                        A && !j && t.dispatch((0, Oe.actionListPlaybackChanged)({ actionListId: b, isPlaying: !1 }));
                    }
                    Es(e, t);
                }
            }
    ...
    var Yy = u((Kj, zy) => {
        ...
        Ir.define(
            ...
            (zy.exports = function (e, t) {
                ...
                function g() {
                    (i = o && Ir.env("design")), (h = Ir.env("slug") || a.pathname || ""), Ir.scroll.off(S), (p = []);
                    for (var A = document.links, w = 0; w < A.length; ++w) b(A[w]);
                    p.length && (Ir.scroll.on(S), S());
                }
                function b(A) {
                    ...
                    function h(x) {
                        if (a) {
                            ...
                            var A = x.touches,
                                ...
                                I = w - E;
                            (E = w), Math.abs(I) > c && r && String(r()) === "" && (i("swipe", x, { direction: I > 0 ? "right" : "left" }), b());
                        }
                    }
                    function g(x) {
    ...
    var em = u((gs) => {
        ...
        function QV(e, t, r, n, i, o, a, s, c, f, E, p, h) {
            return function (g) {
                ...
                p.ajax({ url: h, type: "POST", data: S, dataType: "json", crossDomain: !0 })
                    .done(function (w) {
                ...
                function I(L, H) {
                    ...
                    if (!ue) {
                        if (c) {
                            U.handler = (() => {
                                let ce = em().default;
                                return ce(C, o, Li, ie, M, G, p, j, q, c, P, e, b);
                            })();
                            return;
                        }
                        A();
    ...
    var im = u((Zj, nm) => {
        var Nt = Ye(),
            ZV = Wi(),
            Le = { ARROW_LEFT: 37, ARROW_UP: 38, ARROW_RIGHT: 39, ARROW_DOWN: 40, ESCAPE: 27, SPACE: 32, ENTER: 13, HOME: 36, END: 35 };
        Nt.define(
            "navbar",
            (nm.exports = function (e, t) {
                ...
                function Y(d, V) {
                    ...
                    _e && _e.attr("href") === "/" && _e.attr("aria-label") == null && _e.attr("aria-label", "home"),
                        ...
                        B.menu.off(g),
                        m(B),
                        f ? (ee(B), B.el.on("setting" + g, P(B))) : (D(B), B.button.on("click" + g, L(B)), B.menu.on("click" + g, "a", H(B)), B.button.on("keydown" + g, M(B)), B.el.on("keydown" + g, X(B))),
                        F(d, V);
                }
                function ie(d, V) {
                    var K = e.data(V, g);
                ...
                function Ee(d, V) {
                    if (d.open) return;
                    (d.open = !0), d.menu.each(ce), d.links.addClass(w), d.dropdowns.addClass(S), d.dropdownToggle.addClass(x), d.dropdownList.addClass(A), d.button.addClass(b);
                    var K = d.config,
                        B = K.animation;
...
Webflow.require("ix2").init({
    events: {
        e: {
            ...
            target: { selector: ".thumb-item", originalId: "620249d1c6c2a53372daa63f|7d5e9ea5-e635-17df-4a22-b92c5af2d450", appliesTo: "CLASS" },
            targets: [{ selector: ".thumb-item", originalId: "620249d1c6c2a53372daa63f|7d5e9ea5-e635-17df-4a22-b92c5af2d450", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 5, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
            createdOn: 1644323463585,
        },
        "e-2": {
            id: "e-2",
            name: "",
        ...
        "e-3": {
            ...
            target: { selector: ".thumb-item", originalId: "620249d1c6c2a53372daa63f|7d5e9ea5-e635-17df-4a22-b92c5af2d450", appliesTo: "CLASS" },
            targets: [{ selector: ".thumb-item", originalId: "620249d1c6c2a53372daa63f|7d5e9ea5-e635-17df-4a22-b92c5af2d450", appliesTo: "CLASS" }],
            config: [{ continuousParameterGroupId: "a-3-p", smoothing: 20, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1644323793434,
        },
        "e-5": {
            id: "e-5",
            name: "",
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".thumb-image-width", originalId: "620249d1c6c2a53372daa63f|c4f81071-b5fa-730b-0c10-2aa3940d285c", appliesTo: "CLASS" },
            targets: [{ selector: ".thumb-image-width", originalId: "620249d1c6c2a53372daa63f|c4f81071-b5fa-730b-0c10-2aa3940d285c", appliesTo: "CLASS" }],
            config: [{ continuousParameterGroupId: "a-5-p", smoothing: 20, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1644319039885,
        },
        "e-6": {
            id: "e-6",
            name: "",
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".thumb-image", originalId: "620249d1c6c2a53372daa63f|60e5b141-1b37-ac54-037f-e4e449e216d8", appliesTo: "CLASS" },
            targets: [{ selector: ".thumb-image", originalId: "620249d1c6c2a53372daa63f|60e5b141-1b37-ac54-037f-e4e449e216d8", appliesTo: "CLASS" }],
            config: [{ continuousParameterGroupId: "a-6-p", smoothing: 20, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1644340317120,
        },
        "e-7": {
            id: "e-7",
            name: "",
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63bfc9a079c8e222fe90fe95", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "63bfc9a079c8e222fe90fe95", appliesTo: "PAGE", styleBlockIds: [] }],
        ...
        "e-13": {
            ...
            animationType: "custom",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-11", affectedElements: {}, playInReverse: false, autoStopEventId: "e-35" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".scrolling-loop", originalId: "61385c793ab59f67cf337315|8eb64c00-7953-5a5d-e59b-7ac09ea435d4", appliesTo: "CLASS" },
            targets: [{ selector: ".scrolling-loop", originalId: "61385c793ab59f67cf337315|8eb64c00-7953-5a5d-e59b-7ac09ea435d4", appliesTo: "CLASS" }],
        ...
        "e-18": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63c003d333a4b848d1d9e338", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "63c003d333a4b848d1d9e338", appliesTo: "PAGE", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1673530812544,
        },
        "e-23": {
            id: "e-23",
            name: "",
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63c01a4c465a408f83d6ee22", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "63c01a4c465a408f83d6ee22", appliesTo: "PAGE", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1673534029032,
        },
        "e-24": {
            id: "e-24",
            name: "",
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63c003d333a4b848d1d9e338|1089914d-e967-e57d-dd4f-afb18ebd3078", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63c003d333a4b848d1d9e338|1089914d-e967-e57d-dd4f-afb18ebd3078", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: [
                { continuousParameterGroupId: "a-12-p", selectedAxis: "X_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 96, restingState: 50 },
                { continuousParameterGroupId: "a-12-p-2", selectedAxis: "Y_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 96, restingState: 50 },
            ],
            createdOn: 1673537096675,
        },
        "e-25": {
            id: "e-25",
            name: "",
        ...
        "e-28": {
            ...
            animationType: "preset",
            eventTypeId: "PAGE_FINISH",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-10", affectedElements: {}, playInReverse: false, autoStopEventId: "e-27" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63c7bdace1e71753ed648919", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "63c7bdace1e71753ed648919", appliesTo: "PAGE", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1674034604672,
        },
        "e-29": {
            id: "e-29",
            name: "",
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".scrolling-loop", originalId: "6183b0b424fc6d84b7280c5f|8eb64c00-7953-5a5d-e59b-7ac09ea435d4", appliesTo: "CLASS" },
            targets: [{ selector: ".scrolling-loop", originalId: "6183b0b424fc6d84b7280c5f|8eb64c00-7953-5a5d-e59b-7ac09ea435d4", appliesTo: "CLASS" }],
            config: { loop: true, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
            createdOn: 1629050173130,
        },
        "e-31": {
            ...
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-14", affectedElements: {}, playInReverse: false, autoStopEventId: "e-32" } },
            mediaQueries: ["main"],
            target: { selector: ".footer-link", originalId: "2da9314b-d4d3-9b5e-3e7c-83fb0330f5bd", appliesTo: "CLASS" },
            targets: [{ selector: ".footer-link", originalId: "2da9314b-d4d3-9b5e-3e7c-83fb0330f5bd", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1629119810526,
        },
        "e-32": {
            id: "e-32",
            name: "",
        ...
        "e-33": {
            ...
            mediaQueries: ["main"],
            target: { selector: ".footer-social-link", originalId: "84a540df-6a74-e9be-f957-d17ecf933430", appliesTo: "CLASS" },
            targets: [{ selector: ".footer-social-link", originalId: "84a540df-6a74-e9be-f957-d17ecf933430", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1629103773941,
        },
        "e-34": {
            id: "e-34",
            name: "",
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-17", affectedElements: {}, playInReverse: false, autoStopEventId: "e-33" } },
            mediaQueries: ["main"],
            target: { selector: ".footer-social-link", originalId: "84a540df-6a74-e9be-f957-d17ecf933430", appliesTo: "CLASS" },
            targets: [{ selector: ".footer-social-link", originalId: "84a540df-6a74-e9be-f957-d17ecf933430", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1629103773942,
        },
        "e-35": {
            id: "e-35",
            name: "",
            ...
            mediaQueries: ["main"],
            target: { selector: ".footer-copyright-link.link", originalId: "02e4fa99-5f4d-3792-bf78-eb0cb49ab377", appliesTo: "CLASS" },
            targets: [{ selector: ".footer-copyright-link.link", originalId: "02e4fa99-5f4d-3792-bf78-eb0cb49ab377", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1629115625103,
        },
        "e-36": {
            id: "e-36",
            name: "",
        ...
        "e-37": {
            ...
            mediaQueries: ["main"],
            target: { id: "63c003d333a4b848d1d9e338|fd4fbf87-019b-5a5d-d3a4-40370494a7bd", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63c003d333a4b848d1d9e338|fd4fbf87-019b-5a5d-d3a4-40370494a7bd", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: [{ continuousParameterGroupId: "a-18-p", smoothing: 76, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1677329725903,
        },
        "e-44": {
            id: "e-44",
            name: "",
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".about-scrolling-left", originalId: "63c003d333a4b848d1d9e338|be7fce2e-3fe7-6dce-b313-0843325e6371", appliesTo: "CLASS" },
            targets: [{ selector: ".about-scrolling-left", originalId: "63c003d333a4b848d1d9e338|be7fce2e-3fe7-6dce-b313-0843325e6371", appliesTo: "CLASS" }],
            config: [{ continuousParameterGroupId: "a-20-p", smoothing: 100, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
        ...
        "e-45": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".about-scrolling-right", originalId: "63c003d333a4b848d1d9e338|be7fce2e-3fe7-6dce-b313-0843325e6380", appliesTo: "CLASS" },
            targets: [{ selector: ".about-scrolling-right", originalId: "63c003d333a4b848d1d9e338|be7fce2e-3fe7-6dce-b313-0843325e6380", appliesTo: "CLASS" }],
            config: [{ continuousParameterGroupId: "a-21-p", smoothing: 100, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
        ...
        "e-46": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".award-link", originalId: "903e4831-8a75-097f-28de-85106a2203ef", appliesTo: "CLASS" },
            targets: [{ selector: ".award-link", originalId: "903e4831-8a75-097f-28de-85106a2203ef", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1678198862546,
        },
        "e-47": {
            id: "e-47",
            name: "",
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-23", affectedElements: {}, playInReverse: false, autoStopEventId: "e-46" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".award-link", originalId: "903e4831-8a75-097f-28de-85106a2203ef", appliesTo: "CLASS" },
            targets: [{ selector: ".award-link", originalId: "903e4831-8a75-097f-28de-85106a2203ef", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-48": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".fill-text-item", originalId: "62de4d2b9727780bed6d1119|1614e86b-9590-132c-182a-9c6d613b9132", appliesTo: "CLASS" },
            targets: [{ selector: ".fill-text-item", originalId: "62de4d2b9727780bed6d1119|1614e86b-9590-132c-182a-9c6d613b9132", appliesTo: "CLASS" }],
            config: [{ continuousParameterGroupId: "a-24-p", smoothing: 76, startsEntering: false, addStartOffset: true, addOffsetValue: 50, startsExiting: true, addEndOffset: false, endOffsetValue: 100 }],
        ...
        "e-49": {
            ...
            mediaQueries: ["main"],
            target: { selector: ".footer-trigger", originalId: "63c003d333a4b848d1d9e338|6a7e56b6-76bc-e3ef-b659-d2213a2e432b", appliesTo: "CLASS" },
            targets: [{ selector: ".footer-trigger", originalId: "63c003d333a4b848d1d9e338|6a7e56b6-76bc-e3ef-b659-d2213a2e432b", appliesTo: "CLASS" }],
        ...
        "e-50": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-26", affectedElements: {}, playInReverse: false, autoStopEventId: "e-51" } },
            mediaQueries: ["main"],
            target: { selector: ".award-link", originalId: "903e4831-8a75-097f-28de-85106a2203ef", appliesTo: "CLASS" },
            targets: [{ selector: ".award-link", originalId: "903e4831-8a75-097f-28de-85106a2203ef", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1678262859166,
        },
        "e-51": {
            id: "e-51",
            name: "",
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-27", affectedElements: {}, playInReverse: false, autoStopEventId: "e-50" } },
            mediaQueries: ["main"],
            target: { selector: ".award-link", originalId: "903e4831-8a75-097f-28de-85106a2203ef", appliesTo: "CLASS" },
            targets: [{ selector: ".award-link", originalId: "903e4831-8a75-097f-28de-85106a2203ef", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1678262859167,
        },
        "e-52": {
            id: "e-52",
            name: "",
            ...
            targets: [{ selector: ".award-link", originalId: "903e4831-8a75-097f-28de-85106a2203ef", appliesTo: "CLASS" }],
            config: [
                { continuousParameterGroupId: "a-28-p", selectedAxis: "X_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 96, restingState: 50 },
                { continuousParameterGroupId: "a-28-p-2", selectedAxis: "Y_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 96, restingState: 50 },
            ],
            createdOn: 1678263073029,
        },
        "e-53": {
            id: "e-53",
            name: "",
            animationType: "custom",
            eventTypeId: "MOUSE_MOVE",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-29", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63c003d333a4b848d1d9e338|ef19abaf-cd91-0482-aecd-71ecd6b07581", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63c003d333a4b848d1d9e338|ef19abaf-cd91-0482-aecd-71ecd6b07581", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: [
                { continuousParameterGroupId: "a-29-p", selectedAxis: "X_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 96, restingState: 50 },
                { continuousParameterGroupId: "a-29-p-2", selectedAxis: "Y_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 96, restingState: 50 },
            ],
            createdOn: 1678263142893,
        },
        "e-54": {
            id: "e-54",
            name: "",
            animationType: "custom",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-30", affectedElements: {}, playInReverse: false, autoStopEventId: "e-55" } },
            mediaQueries: ["main"],
            target: { selector: ".magnetic-link", originalId: "7e5e2196-7223-c564-0553-603319437700", appliesTo: "CLASS" },
            targets: [{ selector: ".magnetic-link", originalId: "7e5e2196-7223-c564-0553-603319437700", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1676569848562,
        },
        "e-55": {
            id: "e-55",
            name: "",
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-31", affectedElements: {}, playInReverse: false, autoStopEventId: "e-54" } },
            mediaQueries: ["main"],
            target: { selector: ".magnetic-link", originalId: "7e5e2196-7223-c564-0553-603319437700", appliesTo: "CLASS" },
            targets: [{ selector: ".magnetic-link", originalId: "7e5e2196-7223-c564-0553-603319437700", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-56": {
            ...
            mediaQueries: ["main"],
            target: { selector: ".magnetic-link", originalId: "f49d4314-7d92-0d0c-c96f-870d452db503", appliesTo: "CLASS" },
            targets: [{ selector: ".magnetic-link", originalId: "f49d4314-7d92-0d0c-c96f-870d452db503", appliesTo: "CLASS" }],
            config: [
                { continuousParameterGroupId: "a-32-p", selectedAxis: "X_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 96, restingState: 50 },
                { continuousParameterGroupId: "a-32-p-2", selectedAxis: "Y_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 96, restingState: 50 },
            ],
            createdOn: 1677180194375,
        },
        "e-57": {
            id: "e-57",
            name: "",
            animationType: "preset",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-30", affectedElements: {}, playInReverse: false, autoStopEventId: "e-58" } },
            mediaQueries: ["main"],
            target: { selector: ".magnetic-link", originalId: "63f797661d8b4655c69b6044|25edd370-b334-2397-a674-fb61e2942120", appliesTo: "CLASS" },
            targets: [{ selector: ".magnetic-link", originalId: "63f797661d8b4655c69b6044|25edd370-b334-2397-a674-fb61e2942120", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1677183059996,
        },
        "e-58": {
            id: "e-58",
            name: "",
            animationType: "preset",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-31", affectedElements: {}, playInReverse: false, autoStopEventId: "e-57" } },
            mediaQueries: ["main"],
            target: { selector: ".magnetic-link", originalId: "63f797661d8b4655c69b6044|25edd370-b334-2397-a674-fb61e2942120", appliesTo: "CLASS" },
            targets: [{ selector: ".magnetic-link", originalId: "63f797661d8b4655c69b6044|25edd370-b334-2397-a674-fb61e2942120", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-59": {
            ...
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-32", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main"],
            target: { selector: ".magnetic-link", originalId: "63f797661d8b4655c69b6044|25edd370-b334-2397-a674-fb61e294213b", appliesTo: "CLASS" },
            targets: [{ selector: ".magnetic-link", originalId: "63f797661d8b4655c69b6044|25edd370-b334-2397-a674-fb61e294213b", appliesTo: "CLASS" }],
            config: [
                { continuousParameterGroupId: "a-32-p", selectedAxis: "X_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 96, restingState: 50 },
                { continuousParameterGroupId: "a-32-p-2", selectedAxis: "Y_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 96, restingState: 50 },
            ],
        ...
        "e-60": {
            ...
            mediaQueries: ["main"],
            target: { selector: ".thumb-perspective", originalId: "63bfc9a079c8e222fe90fe95|10a124f8-6c6b-b22b-f7e0-b856ca922447", appliesTo: "CLASS" },
            targets: [{ selector: ".thumb-perspective", originalId: "63bfc9a079c8e222fe90fe95|10a124f8-6c6b-b22b-f7e0-b856ca922447", appliesTo: "CLASS" }],
        ...
        "e-61": {
            ...
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-12", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63c69b24f4f6d51a3c4e550f|4705b7e6-e24f-8033-1420-9631b541e615", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63c69b24f4f6d51a3c4e550f|4705b7e6-e24f-8033-1420-9631b541e615", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: [
                { continuousParameterGroupId: "a-12-p", selectedAxis: "X_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 96, restingState: 50 },
                { continuousParameterGroupId: "a-12-p-2", selectedAxis: "Y_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 96, restingState: 50 },
            ],
            createdOn: 1678694310347,
        },
        "e-62": {
            id: "e-62",
            name: "",
            ...
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-18", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main"],
            target: { id: "63c69b24f4f6d51a3c4e550f|4705b7e6-e24f-8033-1420-9631b541e633", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63c69b24f4f6d51a3c4e550f|4705b7e6-e24f-8033-1420-9631b541e633", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: [{ continuousParameterGroupId: "a-18-p", smoothing: 76, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1678694310347,
        },
        "e-65": {
            ...
            animationType: "custom",
            eventTypeId: "PAGE_FINISH",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-33", affectedElements: {}, playInReverse: false, autoStopEventId: "e-64" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63bfc9a079c8e222fe90fe95", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "63bfc9a079c8e222fe90fe95", appliesTo: "PAGE", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1680518603295,
        },
        "e-67": {
            id: "e-67",
            name: "",
            animationType: "custom",
            eventTypeId: "PAGE_FINISH",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-33", affectedElements: {}, playInReverse: false, autoStopEventId: "e-66" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63c7bdace1e71753ed648919", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "63c7bdace1e71753ed648919", appliesTo: "PAGE", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1680518738724,
        },
        "e-69": {
            id: "e-69",
            name: "",
            animationType: "custom",
            eventTypeId: "PAGE_FINISH",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-33", affectedElements: {}, playInReverse: false, autoStopEventId: "e-68" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63c003d333a4b848d1d9e338", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "63c003d333a4b848d1d9e338", appliesTo: "PAGE", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1680518746756,
        },
        "e-71": {
            id: "e-71",
            name: "",
        ...
        "e-73": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "640edd4d3fa34a0ab8a669da", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "640edd4d3fa34a0ab8a669da", appliesTo: "PAGE", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1680518773650,
        },
        "e-75": {
            id: "e-75",
            name: "",
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63c69b24f4f6d51a3c4e550f", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "63c69b24f4f6d51a3c4e550f", appliesTo: "PAGE", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1680518782356,
        },
    },
    actionLists: {
        a: {
            id: "a",
            title: "Scroll Switch [Title] IN",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                            ...
                            config: { delay: 0, easing: "", duration: 0, target: { useEventTarget: "CHILDREN", selector: ".thumb-title-wrapper", selectorGuids: ["2a41a0ad-07ed-926a-a4d0-7eddd34fe28e"] }, value: "none" },
                        },
                        {
                            id: "a-n-2",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".thumb-title", selectorGuids: ["2a41a0ad-07ed-926a-a4d0-7eddd34fe292"] }, value: 0, unit: "" },
                        },
                    ],
                },
                {
                    actionItems: [
                        {
                            id: "a-n-3",
                            actionTypeId: "GENERAL_DISPLAY",
                            config: { delay: 0, easing: "", duration: 0, target: { useEventTarget: "CHILDREN", selector: ".thumb-title-wrapper", selectorGuids: ["2a41a0ad-07ed-926a-a4d0-7eddd34fe28e"] }, value: "flex" },
                        },
                        {
                            id: "a-n-4",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "ease", duration: 250, target: { useEventTarget: "CHILDREN", selector: ".thumb-title", selectorGuids: ["2a41a0ad-07ed-926a-a4d0-7eddd34fe292"] }, value: 1, unit: "" },
                        },
                    ],
                },
            ],
            useFirstGroupAsInitialState: true,
            createdOn: 1644323472369,
        },
        "a-2": {
            id: "a-2",
            title: "Scroll Switch [Title] OUT",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                            id: "a-2-n",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "ease", duration: 250, target: { useEventTarget: "CHILDREN", selector: ".thumb-title", selectorGuids: ["2a41a0ad-07ed-926a-a4d0-7eddd34fe292"] }, value: 0, unit: "" },
                        },
                    ],
                },
                {
        ...
        "a-3": {
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".thumb-title", selectorGuids: ["2a41a0ad-07ed-926a-a4d0-7eddd34fe292"] },
                                        yValue: 100,
                                        xUnit: "PX",
                                        yUnit: "%",
                                        zUnit: "PX",
            ...
            createdOn: 1644323796609,
        },
        "a-5": {
            id: "a-5",
            title: "Scroll Switch [Rotate Thumb]",
            continuousParameterGroups: [
                {
                    id: "a-5-p",
                    type: "SCROLL_PROGRESS",
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: true, id: "620249d1c6c2a53372daa63f|c4f81071-b5fa-730b-0c10-2aa3940d285c" },
                                        xValue: -10,
                                        yValue: null,
                                        zValue: 10,
                                        xUnit: "px",
            ...
            createdOn: 1644319045816,
        },
        "a-6": {
            id: "a-6",
            title: "Scroll Switch [Image Parallax]",
            continuousParameterGroups: [
                {
                    id: "a-6-p",
                    type: "SCROLL_PROGRESS",
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: true, id: "620249d1c6c2a53372daa63f|b50ad0ec-d538-ca67-6550-1cdde936563b" },
                                        xValue: null,
                                        yValue: -30,
                                        xUnit: "%",
                                        yUnit: "%",
                                ...
                                },
                                {
                                    ...
                                    config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "620249d1c6c2a53372daa63f|b50ad0ec-d538-ca67-6550-1cdde936563b" }, xValue: 1.6, yValue: 1.6, locked: true },
                                },
                                {
                                    id: "a-6-n-3",
                                    actionTypeId: "TRANSFORM_ROTATE",
                                    config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "620249d1c6c2a53372daa63f|b50ad0ec-d538-ca67-6550-1cdde936563b" }, zValue: 0, xUnit: "DEG", yUnit: "DEG", zUnit: "deg" },
                                },
                            ],
                        },
                        {
                            ...
                            actionItems: [
                                {
                                    id: "a-6-n-5",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "620249d1c6c2a53372daa63f|b50ad0ec-d538-ca67-6550-1cdde936563b" }, yValue: 30, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                                },
                                {
                                    id: "a-6-n-6",
                                    actionTypeId: "TRANSFORM_SCALE",
                                    config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "620249d1c6c2a53372daa63f|b50ad0ec-d538-ca67-6550-1cdde936563b" }, xValue: 1, yValue: 1, locked: true },
                                },
                            ],
                        },
                    ],
        ...
        "a-7": {
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { selector: ".scroll-indicator-height-wrapper", selectorGuids: ["61539f12-b295-4924-5256-b8d5aef5c20e"] },
                                        yValue: 0,
                                        xUnit: "PX",
                                        yUnit: "%",
                                        zUnit: "PX",
            ...
            createdOn: 1673517926787,
        },
        "a-11": {
            id: "a-11",
            title: "[🔗 action] Start Ticker Loop",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 20000,
                                target: { useEventTarget: "CHILDREN", selector: ".scrolling-loop-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8b8"] },
                                xValue: -100,
                                xUnit: "%",
                                yUnit: "PX",
                                zUnit: "PX",
                    ...
                    actionItems: [
                        {
                            id: "a-10-n",
                            actionTypeId: "TRANSFORM_ROTATE",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-1st-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8cc"] }, yValue: 90, xUnit: "DEG", yUnit: "deg", zUnit: "DEG" },
                        },
                        {
                            id: "a-10-n-2",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".load-1st-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8cc"] },
                                xValue: 5,
                                yValue: 20,
                                zValue: -15,
                                xUnit: "vw",
                        ...
                        { id: "a-10-n-3", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-1st-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8cc"] }, value: 0, unit: "" } },
                        {
                            id: "a-10-n-4",
                            actionTypeId: "TRANSFORM_ROTATE",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-2nd-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8c2"] }, yValue: 90, xUnit: "DEG", yUnit: "deg", zUnit: "DEG" },
                        },
                        { id: "a-10-n-5", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-2nd-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8c2"] }, value: 0, unit: "" } },
                        {
                            id: "a-10-n-6",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".load-2nd-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8c2"] },
                                xValue: 5,
                                yValue: 20,
                                zValue: -15,
                                xUnit: "vw",
                        ...
                        },
                        {
                            id: "a-10-n-7",
                            actionTypeId: "TRANSFORM_ROTATE",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-3rd-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8cb"] }, yValue: 90, xUnit: "DEG", yUnit: "deg", zUnit: "DEG" },
                        },
                        {
                            id: "a-10-n-8",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".load-3rd-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8cb"] },
                                xValue: 5,
                                yValue: 20,
                                zValue: -15,
                                xUnit: "vw",
                        ...
                        { id: "a-10-n-9", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-3rd-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8cb"] }, value: 0, unit: "" } },
                        {
                            id: "a-10-n-10",
                            actionTypeId: "TRANSFORM_ROTATE",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-4th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8ba"] }, yValue: 90, xUnit: "DEG", yUnit: "deg", zUnit: "DEG" },
                        },
                        {
                            id: "a-10-n-11",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-4th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8ba"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-10-n-12",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".load-4th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8ba"] },
                                xValue: 5,
                                yValue: 20,
                                zValue: -15,
                                xUnit: "vw",
                        ...
                        },
                        {
                            id: "a-10-n-13",
                            actionTypeId: "TRANSFORM_ROTATE",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-5th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8c5"] }, yValue: 90, xUnit: "DEG", yUnit: "deg", zUnit: "DEG" },
                        },
                        {
                            id: "a-10-n-14",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".load-5th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8c5"] },
                                xValue: 5,
                                yValue: 20,
                                zValue: -15,
                                xUnit: "vw",
                        ...
                        },
                        {
                            id: "a-10-n-15",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-5th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8c5"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-10-n-16",
                            actionTypeId: "TRANSFORM_ROTATE",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-6th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8be"] }, yValue: 90, xUnit: "DEG", yUnit: "deg", zUnit: "DEG" },
                        },
                        {
                            id: "a-10-n-17",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-6th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8be"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-10-n-18",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".load-6th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8be"] },
                                xValue: 5,
                                yValue: 20,
                                zValue: -15,
                                xUnit: "vw",
                        ...
                        },
                        {
                            id: "a-10-n-19",
                            actionTypeId: "TRANSFORM_ROTATE",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-7th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8b7"] }, yValue: 90, xUnit: "DEG", yUnit: "deg", zUnit: "DEG" },
                        },
                        {
                            id: "a-10-n-20",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".load-7th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8b7"] },
                                xValue: 5,
                                yValue: 20,
                                zValue: -15,
                                xUnit: "vw",
                        ...
                        },
                        {
                            id: "a-10-n-21",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-7th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8b7"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-10-n-22",
                            actionTypeId: "TRANSFORM_ROTATE",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-8th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8b6"] }, yValue: 90, xUnit: "DEG", yUnit: "deg", zUnit: "DEG" },
                        },
                        {
                            id: "a-10-n-23",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-8th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8b6"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-10-n-24",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".load-8th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8b6"] },
                                xValue: 5,
                                yValue: 20,
                                zValue: -15,
                                xUnit: "vw",
                        ...
                        },
                        {
                            id: "a-10-n-25",
                            actionTypeId: "TRANSFORM_ROTATE",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-9th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8c0"] }, yValue: 90, xUnit: "DEG", yUnit: "deg", zUnit: "DEG" },
                        },
                        {
                            id: "a-10-n-26",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".load-9th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8c0"] },
                                xValue: 5,
                                yValue: 20,
                                zValue: -15,
                                xUnit: "vw",
                        ...
                        },
                        {
                            id: "a-10-n-27",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-9th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8c0"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-10-n-28",
                            actionTypeId: "TRANSFORM_ROTATE",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-10th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8bb"] }, yValue: 90, xUnit: "DEG", yUnit: "deg", zUnit: "DEG" },
                        },
                        {
                            id: "a-10-n-29",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-10th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8bb"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-10-n-30",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".load-10th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8bb"] },
                                xValue: 5,
                                yValue: 20,
                                zValue: -15,
                                xUnit: "vw",
                        ...
                        },
                        {
                            id: "a-10-n-31",
                            actionTypeId: "TRANSFORM_ROTATE",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-11th-item", selectorGuids: ["c99bb8ec-08c0-1e02-6fc8-1820faa272fb"] }, yValue: 90, xUnit: "DEG", yUnit: "deg", zUnit: "DEG" },
                        },
                        {
                            id: "a-10-n-32",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".load-11th-item", selectorGuids: ["c99bb8ec-08c0-1e02-6fc8-1820faa272fb"] },
                                xValue: 5,
                                yValue: 20,
                                zValue: -15,
                                xUnit: "vw",
                        ...
                        },
                        {
                            id: "a-10-n-33",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".load-11th-item", selectorGuids: ["c99bb8ec-08c0-1e02-6fc8-1820faa272fb"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-10-n-34",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".about-image", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8c4"] },
                                xValue: 50,
                                yValue: 200,
                                zValue: 10,
                                xUnit: "vw",
                        ...
                        },
                        {
                            id: "a-10-n-35",
                            actionTypeId: "TRANSFORM_ROTATE",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".about-image", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8c4"] }, yValue: 0, zValue: -6, xUnit: "DEG", yUnit: "deg", zUnit: "deg" },
                        },
                        { id: "a-10-n-71", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { selector: ".show-on-load", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8bc"] }, value: 0, unit: "" } },
                    ],
                },
                {
                    actionItems: [
                        ...
                        },
                        {
                            id: "a-10-n-37",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 500, easing: [0.425, 0.005, 0, 1], duration: 1300, target: { selector: ".load-1st-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8cc"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-10-n-38",
                            actionTypeId: "TRANSFORM_MOVE",
                        ...
                        },
                        {
                            id: "a-10-n-41",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 550, easing: [0.425, 0.005, 0, 1], duration: 1300, target: { selector: ".load-2nd-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8c2"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-10-n-42",
                            actionTypeId: "TRANSFORM_ROTATE",
                        ...
                        },
                        {
                            id: "a-10-n-43",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 600, easing: [0.425, 0.005, 0, 1], duration: 1300, target: { selector: ".load-3rd-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8cb"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-10-n-44",
                            actionTypeId: "TRANSFORM_MOVE",
                        ...
                        },
                        {
                            id: "a-10-n-45",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 650, easing: [0.425, 0.005, 0, 1], duration: 1300, target: { selector: ".load-4th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8ba"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-10-n-46",
                            actionTypeId: "TRANSFORM_ROTATE",
                        ...
                        },
                        {
                            id: "a-10-n-49",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 700, easing: [0.425, 0.005, 0, 1], duration: 1300, target: { selector: ".load-5th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8c5"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-10-n-50",
                            actionTypeId: "TRANSFORM_MOVE",
                        ...
                        },
                        {
                            id: "a-10-n-72",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 700, easing: [0.425, 0.005, 0, 1], duration: 1000, target: { selector: ".show-on-load", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8bc"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-10-n-53",
                            actionTypeId: "TRANSFORM_ROTATE",
                        ...
                        },
                        {
                            id: "a-10-n-55",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 750, easing: [0.425, 0.005, 0, 1], duration: 1300, target: { selector: ".load-6th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8be"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-10-n-56",
                            actionTypeId: "TRANSFORM_ROTATE",
                        ...
                        },
                        {
                            id: "a-10-n-57",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 800, easing: [0.425, 0.005, 0, 1], duration: 1300, target: { selector: ".load-7th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8b7"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-10-n-58",
                            actionTypeId: "TRANSFORM_MOVE",
                        ...
                        },
                        {
                            id: "a-10-n-61",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 850, easing: [0.425, 0.005, 0, 1], duration: 1300, target: { selector: ".load-8th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8b6"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-10-n-62",
                            actionTypeId: "TRANSFORM_ROTATE",
                        ...
                        },
                        {
                            id: "a-10-n-63",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 900, easing: [0.425, 0.005, 0, 1], duration: 1300, target: { selector: ".load-9th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8c0"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-10-n-64",
                            actionTypeId: "TRANSFORM_MOVE",
                        ...
                        },
                        {
                            id: "a-10-n-67",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 950, easing: [0.425, 0.005, 0, 1], duration: 1300, target: { selector: ".load-10th-item", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8bb"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-10-n-68",
                            actionTypeId: "TRANSFORM_ROTATE",
                        ...
                        },
                        {
                            id: "a-10-n-69",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 1000, easing: [0.425, 0.005, 0, 1], duration: 1300, target: { selector: ".load-11th-item", selectorGuids: ["c99bb8ec-08c0-1e02-6fc8-1820faa272fb"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-10-n-70",
                            actionTypeId: "TRANSFORM_MOVE",
                            ...
                            actionItems: [
                                {
                                    id: "a-12-n",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "63c003d333a4b848d1d9e338|1089914d-e967-e57d-dd4f-afb18ebd3078" }, xValue: -3, xUnit: "vw", yUnit: "PX", zUnit: "PX" },
                                },
                                { id: "a-12-n-5", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, xValue: 2, xUnit: "vw", yUnit: "PX", zUnit: "PX" } },
                            ],
                        },
                        {
                            keyframe: 100,
                            actionItems: [
                                ...
                                { id: "a-12-n-6", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, xValue: -2, xUnit: "vw", yUnit: "PX", zUnit: "PX" } },
                            ],
                        },
                    ],
                },
                            ...
                            actionItems: [
                                {
                                    id: "a-12-n-3",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "63c003d333a4b848d1d9e338|1089914d-e967-e57d-dd4f-afb18ebd3078" }, yValue: -3, xUnit: "PX", yUnit: "vw", zUnit: "PX" },
                                },
                                { id: "a-12-n-7", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, yValue: 2, xUnit: "PX", yUnit: "vw", zUnit: "PX" } },
                            ],
                        },
                        {
                            keyframe: 100,
                            actionItems: [
                                ...
                                { id: "a-12-n-8", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, yValue: -2, xUnit: "PX", yUnit: "vw", zUnit: "PX" } },
                            ],
                        },
                    ],
                },
            ],
            createdOn: 1673536710028,
        },
        "a-13": {
            id: "a-13",
            title: "[🔗 action] Start Ticker Loop 2",
            actionItemGroups: [
                {
                    actionItems: [
                        {
        ...
        "a-14": {
            ...
            actionItemGroups: [
                { actionItems: [{ id: "a-14-n", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, xValue: -102, xUnit: "%", yUnit: "PX", zUnit: "PX" } }] },
                { actionItems: [{ id: "a-14-n-2", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: [0.77, 0, 0.175, 1], duration: 300, target: {}, xValue: 0, xUnit: "%", yUnit: "PX", zUnit: "PX" } }] },
            ],
            useFirstGroupAsInitialState: true,
            createdOn: 1628698584306,
        },
        "a-15": {
            id: "a-15",
            title: "[👆hover] Hide Underline [out]",
            actionItemGroups: [
                { actionItems: [{ id: "a-15-n", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: [0.77, 0, 0.175, 1], duration: 300, target: {}, xValue: 102, xUnit: "%", yUnit: "PX", zUnit: "PX" } }] },
                { actionItems: [{ id: "a-15-n-2", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 0, target: {}, xValue: -102, xUnit: "%", yUnit: "PX", zUnit: "PX" } }] },
            ],
            useFirstGroupAsInitialState: false,
            createdOn: 1628698584306,
        },
        "a-16": {
            id: "a-16",
            title: "[👆hover] Footer #1 Social Link [in]",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".footer-social-link-hover", selectorGuids: ["3d0b59ad-c88f-cdac-7058-a3c656319d1b"] },
                                xValue: 0,
                                yValue: 0,
                                locked: true,
                            },
        ...
        "a-17": {
            id: "a-17",
            title: "[👆hover] Footer #1 Social Link [out]",
            actionItemGroups: [
                {
                    actionItems: [
                        {
        ...
        "a-18": {
            id: "a-18",
            title: "Next Chapter / Hero [Desktop]",
            continuousParameterGroups: [
                {
                    id: "a-18-p",
                    type: "SCROLL_PROGRESS",
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "SIBLINGS", selector: "._1st-section-wrapper", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8bf"] },
                                        yValue: 0,
                                        xUnit: "PX",
                                        yUnit: "vh",
                                        zUnit: "PX",
                                ...
                                },
                                {
                                    id: "a-18-n-3",
                                    actionTypeId: "STYLE_OPACITY",
                                    config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "SIBLINGS", selector: "._1st-section-wrapper", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8bf"] }, value: 1, unit: "" },
                                },
                                {
                                    id: "a-18-n-4",
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "PARENT", selector: "._1st-section", selectorGuids: ["dd190742-5b9f-5ec6-9a7f-000128de0e56"] },
                                        globalSwatchId: "40cb68f1",
                                        rValue: 34,
                                        bValue: 34,
                                        gValue: 34,
                                        aValue: 1,
                                ...
                                },
                                {
                                    id: "a-18-n-9",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".image-wrapper", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8ca"] }, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                                },
                                {
                                    id: "a-18-n-11",
                                    actionTypeId: "TRANSFORM_ROTATE",
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".image-wrapper", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8ca"] }, zValue: 0, xUnit: "DEG", yUnit: "DEG", zUnit: "deg" },
                                },
                            ],
                        },
                        {
                            ...
                            actionItems: [
                                ...
                                },
                                {
                                    id: "a-18-n-7",
                                    actionTypeId: "STYLE_OPACITY",
                                    config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "SIBLINGS", selector: "._1st-section-wrapper", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8bf"] }, value: 0.25, unit: "" },
                                },
                                {
                                    id: "a-18-n-8",
                                    actionTypeId: "STYLE_BACKGROUND_COLOR",
                                ...
                                },
                                {
                                    id: "a-18-n-10",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".image-wrapper", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8ca"] }, yValue: -50, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                                },
                                {
                                    id: "a-18-n-12",
                                    actionTypeId: "TRANSFORM_ROTATE",
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".image-wrapper", selectorGuids: ["dca17644-a3bd-0c1f-533d-c7056212a8ca"] }, zValue: 8, xUnit: "DEG", yUnit: "DEG", zUnit: "deg" },
                                },
                            ],
                        },
                    ],
                            ...
                            actionItems: [
                                {
                                    id: "a-20-n",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "63c003d333a4b848d1d9e338|be7fce2e-3fe7-6dce-b313-0843325e6371" }, xValue: 0, xUnit: "%", yUnit: "PX", zUnit: "PX" },
                                },
                            ],
                        },
                        {
                            ...
                            actionItems: [
                                {
                                    id: "a-20-n-2",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "63c003d333a4b848d1d9e338|be7fce2e-3fe7-6dce-b313-0843325e6371" }, xValue: -25, xUnit: "%", yUnit: "PX", zUnit: "PX" },
                                },
                            ],
                        },
                    ],
        ...
        "a-22": {
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".award-bg", selectorGuids: ["f72f102c-b661-2b74-e883-8b37be533b21"] },
                                heightValue: 0,
                                widthUnit: "PX",
                                heightUnit: "%",
                                locked: false,
            ...
            useFirstGroupAsInitialState: true,
            createdOn: 1678198864826,
        },
        "a-23": {
            id: "a-23",
            title: "Award Link -> Out",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".fill-text-hover-row", selectorGuids: ["c4a0f81b-2449-2611-6e25-a9667d2d55d2"] },
                                        widthValue: 0,
                                        widthUnit: "%",
                                        heightUnit: "PX",
                                        locked: false,
        ...
        "a-25": {
                            ...
                            actionItems: [
                                {
                                    id: "a-25-n",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".footer", selectorGuids: ["3d0b59ad-c88f-cdac-7058-a3c656319d1f"] }, yValue: 25, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                                },
                                {
                                    id: "a-25-n-5",
                                    actionTypeId: "TRANSFORM_SCALE",
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".footer", selectorGuids: ["3d0b59ad-c88f-cdac-7058-a3c656319d1f"] }, xValue: 0.9, yValue: 0.9, locked: true },
                                },
                                {
                                    id: "a-25-n-3",
                                    actionTypeId: "STYLE_OPACITY",
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".footer", selectorGuids: ["3d0b59ad-c88f-cdac-7058-a3c656319d1f"] }, value: 0.25, unit: "" },
                                },
                            ],
                        },
                        {
                            ...
                            actionItems: [
                                {
                                    id: "a-25-n-2",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".footer", selectorGuids: ["3d0b59ad-c88f-cdac-7058-a3c656319d1f"] }, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                                },
                                {
                                    id: "a-25-n-4",
                                    actionTypeId: "STYLE_OPACITY",
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".footer", selectorGuids: ["3d0b59ad-c88f-cdac-7058-a3c656319d1f"] }, value: 1, unit: "" },
                                },
                                {
                                    id: "a-25-n-6",
                                    actionTypeId: "TRANSFORM_SCALE",
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".footer", selectorGuids: ["3d0b59ad-c88f-cdac-7058-a3c656319d1f"] }, xValue: 1, yValue: 1, locked: true },
                                },
                            ],
                        },
                    ],
            ...
            createdOn: 1678217039056,
        },
        "a-26": {
            id: "a-26",
            title: "Award -> Show Image",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".award-image-aspect-ratio", selectorGuids: ["c2962461-22c4-405c-adc9-cf30532cc2a0"] },
                                xValue: 0.6,
                                yValue: 0.6,
                                locked: true,
                            },
                        },
                        {
                            id: "a-26-n-2",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".award-image-aspect-ratio", selectorGuids: ["c2962461-22c4-405c-adc9-cf30532cc2a0"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-26-n-3",
                            actionTypeId: "TRANSFORM_SCALE",
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".award-image", selectorGuids: ["e703f87d-9ccc-b565-c43f-7905881a4044"] }, xValue: 1.4, yValue: 1.4, locked: true },
                        },
                    ],
                },
                {
                    actionItems: [
                        ...
                        },
                        {
                            id: "a-26-n-5",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 100, easing: "ease", duration: 300, target: { useEventTarget: "CHILDREN", selector: ".award-image-aspect-ratio", selectorGuids: ["c2962461-22c4-405c-adc9-cf30532cc2a0"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-26-n-6",
                            actionTypeId: "TRANSFORM_SCALE",
                            config: {
                                ...
                                easing: [0.2, 1, 0.23, 1],
                                duration: 900,
                                target: { useEventTarget: "CHILDREN", selector: ".award-image", selectorGuids: ["e703f87d-9ccc-b565-c43f-7905881a4044"] },
                                xValue: 1,
                                yValue: 1,
                                locked: true,
                            },
            ...
            useFirstGroupAsInitialState: true,
            createdOn: 1678262867069,
        },
        "a-27": {
            id: "a-27",
            title: "Award -> Hide Image",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                        ...
                        },
                        {
                            id: "a-27-n-5",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "ease", duration: 250, target: { useEventTarget: "CHILDREN", selector: ".award-image-aspect-ratio", selectorGuids: ["c2962461-22c4-405c-adc9-cf30532cc2a0"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-27-n-6",
                            actionTypeId: "TRANSFORM_SCALE",
        ...
        "a-28": {
            id: "a-28",
            title: "Award -> Move Image",
            continuousParameterGroups: [
                { id: "a-28-p", type: "MOUSE_X", parameterLabel: "Mouse X", continuousActionGroups: [] },
                {
                    id: "a-28-p-2",
                    type: "MOUSE_Y",
                    parameterLabel: "Mouse Y",
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".award-image-width", selectorGuids: ["3d9f226f-98ed-ac6d-becc-24955ee5f184"] },
                                        yValue: -25,
                                        xUnit: "PX",
                                        yUnit: "%",
                                        zUnit: "PX",
            ...
            createdOn: 1678263075375,
        },
        "a-29": {
            id: "a-29",
            title: "Award -> Rotate Image",
            continuousParameterGroups: [
                {
                    id: "a-29-p",
                    type: "MOUSE_X",
                            ...
                            actionItems: [
                                {
                                    id: "a-29-n",
                                    actionTypeId: "TRANSFORM_ROTATE",
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".award-image-hover", selectorGuids: ["3ded30fb-dcc8-b94e-25a7-a490886bb62e"] }, zValue: -6, xUnit: "DEG", yUnit: "DEG", zUnit: "deg" },
                                },
                                {
                                    id: "a-29-n-3",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".award-image-hover", selectorGuids: ["3ded30fb-dcc8-b94e-25a7-a490886bb62e"] }, xValue: -100, xUnit: "%", yUnit: "PX", zUnit: "PX" },
                                },
                            ],
                        },
                        {
                ...
                { id: "a-29-p-2", type: "MOUSE_Y", parameterLabel: "Mouse Y", continuousActionGroups: [] },
            ],
            createdOn: 1678263145294,
        },
        "a-30": {
            id: "a-30",
            title: "Link -> Move Label In",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                duration: 1000,
                                target: { useEventTarget: "CHILDREN", selector: ".link-label", selectorGuids: ["68a7121a-466e-5f2a-7794-264e0392380b"] },
                                yValue: -100,
                                xUnit: "PX",
                                yUnit: "%",
                                zUnit: "PX",
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                easing: [0.23, 1, 0.32, 1],
                                duration: 1000,
                                target: { useEventTarget: "CHILDREN", selector: ".link-label.on-hover", selectorGuids: ["68a7121a-466e-5f2a-7794-264e0392380b", "68a7121a-466e-5f2a-7794-264e0392380c"] },
                                yValue: -100,
                                xUnit: "PX",
                                yUnit: "%",
                                zUnit: "PX",
            ...
            useFirstGroupAsInitialState: false,
            createdOn: 1675086079976,
        },
        "a-31": {
            id: "a-31",
            title: "Link -> Move Label Out",
            actionItemGroups: [
                {
                    actionItems: [
                        {
        ...
        "a-32": {
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".magnetic-item", selectorGuids: ["68a7121a-466e-5f2a-7794-264e03923809"] },
                                        xValue: -5,
                                        xUnit: "%",
                                        yUnit: "PX",
                                        zUnit: "PX",
                                ...
                                },
                                {
                                    id: "a-32-n-2",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "f49d4314-7d92-0d0c-c96f-870d452db503" }, xValue: -2.5, xUnit: "%", yUnit: "PX", zUnit: "PX" },
                                },
                            ],
                        },
                        {
                    ...
                    continuousActionGroups: [
                        {
                            ...
                            actionItems: [
                                ...
                                },
                                {
                                    id: "a-32-n-6",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "f49d4314-7d92-0d0c-c96f-870d452db503" }, yValue: -5, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                                },
                            ],
                        },
                        {
            ...
            createdOn: 1675758284945,
        },
        "a-4": {
            id: "a-4",
            title: "Scroll Switch [Image Wrap Parallax]",
            continuousParameterGroups: [
                {
                    id: "a-4-p",
                    type: "SCROLL_PROGRESS",
        ...
        "a-33": {
            ...
            actionItemGroups: [
                {
                    actionItems: [
                        { id: "a-33-n-2", actionTypeId: "GENERAL_DISPLAY", config: { delay: 0, easing: "", duration: 0, target: { selector: ".preloader", selectorGuids: ["19a83063-59c7-875b-e690-e79261d1525d"] }, value: "flex" } },
                        { id: "a-33-n", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { selector: ".layout", selectorGuids: ["2a41a0ad-07ed-926a-a4d0-7eddd34fe296"] }, value: 0, unit: "" } },
                    ],
                },
                {
                    actionItems: [
                        { id: "a-33-n-3", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "ease", duration: 500, target: { selector: ".layout", selectorGuids: ["2a41a0ad-07ed-926a-a4d0-7eddd34fe296"] }, value: 1, unit: "" } },
                        { id: "a-33-n-4", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "ease", duration: 500, target: { selector: ".preloader", selectorGuids: ["19a83063-59c7-875b-e690-e79261d1525d"] }, value: 0, unit: "" } },
                    ],
                },
                {
                    actionItems: [
                        { id: "a-33-n-5", actionTypeId: "GENERAL_DISPLAY", config: { delay: 0, easing: "", duration: 0, target: { selector: ".preloader", selectorGuids: ["19a83063-59c7-875b-e690-e79261d1525d"] }, value: "none" } },
                    ],
                },
            ],
            useFirstGroupAsInitialState: true,
            createdOn: 1680518607169,
        },
    },
    site: {
        mediaQueries: [
